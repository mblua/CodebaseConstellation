...
export class InvalidJsonError extends GuideError {
...
export class IncompatibleVersionError extends GuideError {
  ...
  constructor(documentVersion: string, supportedVersion: string) {
    super(
      ...
      `This document declares formatVersion ${documentVersion}; this build of CodebaseGuide reads ${supportedVersion}.x. ` +
