...
- Name: regate.spec.ts >> editable Preview guard survives stale DOM invocation and returns recovery to owner B
  ...
  - complementary "Project" [ref=e5]:
    ...
    - generic [ref=e9]:
      - paragraph [ref=e10]:
        ...
        - generic [ref=e12]: Independent editable owner
      - generic [ref=e13]:
        - generic [ref=e14]: Project name
        - textbox "Project name" [ref=e15]:
          - /placeholder: Visual Specs
          - text: Independent editable owner
      - button "Open Project" [ref=e16] [cursor=pointer]
    - generic [ref=e17]:
      - group "Project Independent editable owner. Project ID b42ba9b6-1db2-4a24-94c8-d5fc814fd8c9." [ref=e18]:
        - generic [ref=e19]: Project Independent editable owner. Project ID b42ba9b6-1db2-4a24-94c8-d5fc814fd8c9.
        - generic [ref=e20]: Project preview
        - generic [ref=e21]: Independent editable owner
        - generic [ref=e22]: Project ID
        - generic [ref=e23]: b42ba9b6-1db2-4a24-94c8- d5fc814fd8c9
    ...
    - generic [ref=e32]: "Project access: editable. Preview only; the project remains open and export uses save picker. Previewing export copy 20260714-071358_Independent-editable-owner.json. Use Return to project when done."
  - generic [ref=e33]:
